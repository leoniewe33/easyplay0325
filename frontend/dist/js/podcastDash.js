...
})({"2TqKz":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "016327124501f70a";
"use strict";
...
},{}],"j0nKJ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _hakenPng = require("/images/Haken.png");
var _hakenPngDefault = parcelHelpers.interopDefault(_hakenPng);
var _playButtonPng = require("/images/play-button.png");
var _playButtonPngDefault = parcelHelpers.interopDefault(_playButtonPng);
var episodeCount = 20;
var URLplaying = null;
loadFavorites();
...
async function getPodcast() {
    ...
    try {
        ...
        document.getElementById('podcast-list').innerHTML = '<p class="loading-message">Fehler beim Laden von Podcasts. Bitte probiere es sp\xe4ter nochmal.</p>';
    }
}
...
async function fetchAudio(id, episodeCount) {
    ...
    try {
        ...
        const data = await response.json();
        insertEpisodes(data);
        if (data.data.episodes.length < episodeCount) document.getElementById('moreBtn').style.display = 'none';
        else document.getElementById('moreBtn').style.display = 'inline'; // "More"-Button anzeigen
        if (episodeCount <= 1) document.getElementById('lessBtn').style.display = 'none';
        else document.getElementById('lessBtn').style.display = 'inline'; // "Less"-Button anzeigen
    } catch (error) {
        console.error('Error fetching podcasts:', error);
        document.getElementById('episodes-div').innerHTML = '<p class="loading-message">Fehler beim Laden von Podcasts. Bitte probiere es sp\xe4ter nochmal.</p>';
    }
...
function fetchNewAudio(change) {
    ...
    if (change === -1) {
        if (episodeCount <= 20) episodeCount = 1;
        else episodeCount -= 20;
        fetchAudio(getQueryParams().id, episodeCount);
    }
}
...
function insertEpisodes(data) {
    ...
    data.data.episodes.forEach((element, index)=>{
        ...
        divEpisode.addEventListener('click', function() {
            ...
            if (description.style.display === "none" || description.style.display === "") description.style.display = "block";
...
async function addFavourite() {
    ...
    try {
        ...
        const data = await response.json();
        if (response.ok) {
            document.getElementById("fav-btn-image").src = (0, _hakenPngDefault.default);
...
async function loadFavorites() {
    try {
        ...
        if (response.ok) {
            const podcastId = getQueryParams().id;
            if (data.favorites.includes(podcastId)) document.getElementById("fav-btn-image").src = (0, _hakenPngDefault.default);
        }
    } catch (error) {
...
},{"/images/Haken.png":"3gOJG","/images/play-button.png":"eR0vM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3gOJG":[function(require,module,exports,__globalThis) {
module.exports = require("341c60b6345d7882").getBundleURL('7nQzD') + "../Haken.efe9cfd2.png" + "?" + Date.now();

},{"341c60b6345d7882":"lgJ39"}],"lgJ39":[function(require,module,exports,__globalThis) {
"use strict";
var bundleURL = {};
...
},{}],"eR0vM":[function(require,module,exports,__globalThis) {
module.exports = require("adc4b0b9cb4f65e0").getBundleURL('7nQzD') + "../play-button.05dff685.png" + "?" + Date.now();

},{"adc4b0b9cb4f65e0":"lgJ39"}],"gkKU3":[function(require,module,exports,__globalThis) {
...
},{}]},["2TqKz","j0nKJ"], "j0nKJ", "parcelRequire94c2")

//# sourceMappingURL=podcastDash.js.map
