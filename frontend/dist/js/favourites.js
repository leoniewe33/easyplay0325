...
})({"3X2zP":[function(require,module,exports,__globalThis) {
...
},{}],"kiwNd":[function(require,module,exports,__globalThis) {
...
async function removeFavourite(podcastId) {
    try {
        ...
        const data = await response.json();
        console.log('Favorit entfernt', data.favorites);
    } catch (error) {
...
},{"/images/Haken.png":"8fhKn","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8fhKn":[function(require,module,exports,__globalThis) {
module.exports = require("e93e23c5ebcc784c").getBundleURL('d8QJO') + "../Haken.efe9cfd2.png" + "?" + Date.now();

},{"e93e23c5ebcc784c":"lgJ39"}],"lgJ39":[function(require,module,exports,__globalThis) {
"use strict";
var bundleURL = {};
...
},{}]},["3X2zP","kiwNd"], "kiwNd", "parcelRequire94c2")
